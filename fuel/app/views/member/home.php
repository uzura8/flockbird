	...
	<div class="article">
		<div class="header">
			...
			<div class="member_img_box_s">
				<?php echo img($note->member->get_image(), '30x30xc', 'member/'.$note->member_id, false, '', true); ?>
				<div class="content">
					<div class="main">
		...
		<div class="body"><?php echo nl2br(strim($note->body, Config::get('note.articles.trim_width'))); ?></div>
	</div>
<?php endforeach; ?>
</div>
<?php else: ?>
