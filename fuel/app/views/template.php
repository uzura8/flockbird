...
<?php if (Auth::check()): ?>
			...
			<?php echo render('_parts/nav_list', array(
				'header' => t('site.member_menu'),
				'list' => Config::get('navigation.site.secure_side')
			)); ?>
<?php endif; ?>
<?php if (conf('viewParams.site.sideMenu.categoryList', 'news')
				&& $news_categories = \News\Site_Util::get_category_uris(conf('viewParams.site.sideMenu.categoryList.withAllLink', 'news'))): ?>
			<?php echo render('_parts/nav_list', array(
				'header' => term('news.category.view'),
				'list' => $news_categories
			)); ?>
<?php endif; ?>
			<?php echo render('_parts/nav_list', array(
				'header' => t('site.site_menu'),
				'list' => Config::get('navigation.site.global_side')
			)); ?>
