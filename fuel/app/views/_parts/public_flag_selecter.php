...
<?php else: ?>
		<li><a href="#" class="update_public_flag" data-id="<?php echo $id; ?>" data-public_flag="<?php echo $public_flag_value; ?>" data-model="<?php echo $model; ?>"><?php echo $term_public_flags[$public_flag_value]; ?></a></li>
<?php endif; ?>
<?php endforeach; ?>
	</ul>
</div>
