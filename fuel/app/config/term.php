...
$config = array(
	'form' => array(
		...
		'close' => '閉じる',
		'do_write_for' => ':labelを書く',
		'do_display' => '表示する',
		'do_not_display' => '表示しない',
		'do_display_for' => ':labelを表示する',
		'do_see_for' => ':labelをみる',
		'do_not_change' => '変更しない',
		'toggle_all_select_none' => 'すべて選択/解除',
		'input_value' => '入力値',
	),
	'site' => array(
		'view' => 'サイト',
	...
	'system' => array(
		'dir' => 'ディレクトリ',
		'currently_unavailable_for' => ':labelは現在ご利用いただけません',
	),
	'member' => array(
		'view' => 'メンバー',
		'plural' => 'メンバー',
		...
		'birthyear' => '生年',
		'birthdate' => '誕生日',
		'birthdate_month' => '誕生日(月)',
		'birthdate_date' => '誕生日(日)',
		'birthday' => '生年月日',
		'age' => '年齢',
		'generation' => '年代',
		'country' => '居住国',
