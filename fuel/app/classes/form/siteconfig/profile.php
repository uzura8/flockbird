...
class Form_SiteConfig_Profile extends Form_SiteConfig
{
	...
	public static function get_validation_sex($is_set_saved_value = false)
	{
		...
		$atters['value'] = $is_set_saved_value ? self::get_values($name, \Config::get('site.public_flag.default')) : \Config::get('site.public_flag.default');
	...
	public static function get_validation_birthday($is_set_saved_value = false)
	{
