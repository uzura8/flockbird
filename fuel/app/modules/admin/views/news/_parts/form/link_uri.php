...
<div class="row mb10 link_row" id="<?php echo $row_id; ?>">
	<div class="col-sm-6<?php if ($val->error($name_link_uri)): ?> has-error<?php endif; ?>">
		...
		<?php echo Form::input($name_link_uri, $values['uri'], array('type' => 'text', 'class' => 'form-control link_uri', 'placeholder' => 'http://example.com')); ?>
	</div>
	<div class="col-sm-4<?php if ($val->error($name_link_label)): ?> has-error<?php endif; ?>">
		...
		<?php echo Form::input($name_link_label, isset($values['label']) ? $values['label'] : '', array('type' => 'text', 'class' => 'form-control link_label', 'placeholder' => 'リンク表示')); ?>
	</div>
	<div class="col-sm-2">
