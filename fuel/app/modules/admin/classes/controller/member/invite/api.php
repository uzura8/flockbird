...
class Controller_Member_Invite_Api extends Controller_Admin
{
	...
	public function post_cancel($id = null)
	{
		$this->controller_common_api(function() use($id)
		{
			...
			$member_pre = \Model_MemberPre::check_authority($id, \Site_Member::get_admin_member_id(), null, 'invite_member_id');
