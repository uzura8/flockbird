	...
	<div class="article">
		<div class="header">
			...
			<div class="member_img_box_s">
				<?php echo img(empty($note->member) ? 'm' : $note->member->get_image(), '30x30', 'member/'.$note->member_id); ?>
				<div class="content">
					<div class="main">
						<b class="fullname"><?php echo empty($note->member) ? Config::get('site.term.left_member') : Html::anchor('member/'.$note->member_id, $note->member->name); ?></b>
					</div>
