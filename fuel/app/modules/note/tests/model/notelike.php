...
//	{
//		self::$note_comment_count = \Util_Orm::get_count_all('\Note\Model_NoteLike', array('note_id' => self::$note_id));
//
...
//
//		// note_comment save
//		\Note\Model_NoteLike::save_comment($note_id, $member_id, $body);
//		$note_comment = \Util_Orm::get_last_row('\Note\Model_NoteLike', array('note_id' => $note_id));
//		$note = \DB::select()->from('note')->where('id', $note_id)->execute()->current();
//
//		// 件数
//		$comment_count = \Util_Orm::get_count_all('\Note\Model_NoteLike', array('note_id' => $note_id));
...
//		$note_id = self::$note_id;
//
//		\Note\Model_NoteLike::save_comment(self::$note_id, 1, 'Test comment1.');
//		\Note\Model_NoteLike::save_comment(self::$note_id, 1, 'Test comment2.');
//		$note_comment = \Note\Model_NoteLike::save_comment(self::$note_id, 1, 'Test comment3.');
//
//		// note_comment delete
//		$note_comment->delete();
//		$note = \DB::select()->from('note')->where('id', $note_id)->execute()->current();
