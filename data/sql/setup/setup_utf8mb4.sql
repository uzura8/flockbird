...
CREATE TABLE `notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `foreign_table` varchar(64) NOT NULL COMMENT 'Reference table name',
  `foreign_id` varchar(10) NOT NULL COMMENT 'The id of reference table',
  `type` tinyint(2) NOT NULL DEFAULT '0',
  `body` text NULL,
  `parent_table` varchar(64) NULL COMMENT 'Use for open page url.',
  `parent_id` varchar(10) NULL COMMENT 'Use for open page url.',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `member_watch_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `foreign_table` varchar(64) NULL COMMENT 'Reference table name',
